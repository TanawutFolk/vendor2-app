...
const CustomerInvoiceToViewModal = ({
  openModalView,
  setOpenModalView,
  rowSelected,
  setIsEnableFetching
  ...
  const handleUpdate = () => {
    ...
    const dataItem = {
      ...
      CUSTOMER_INVOICE_TO_NAME: getValues('CUSTOMER_INVOICE_TO_NAME'),
      CUSTOMER_INVOICE_TO_ALPHABET: getValues('CUSTOMER_INVOICE_TO_ALPHABET'),
    ...
    <>
      ...
      >
        ...
        <DialogContent>
          ...
          <Grid className='mb-3'>
            <Controller
              name='CUSTOMER_INVOICE_TO_ALPHABET'
              control={control}
              render={({ field }) => (
                <CustomTextField
                  {...field}
...
export default CustomerInvoiceToViewModal
