...
import { PREFIX_QUERY_KEY, useDeleteCustomerInvoiceTo } from '@/_workspace/react-query/hooks/useCustomerInvoiceToData'
...
interface CustomerInvoiceToDeleteModalProps {
...
// Types
const CustomerInvoiceToDeleteModal = ({
  openModalDelete,
  setOpenModalDelete,
  rowSelected,
  setIsEnableFetching
}: CustomerInvoiceToDeleteModalProps) => {
  // useState
  ...
  const mutation = useDeleteCustomerInvoiceTo(onMutateSuccess, onMutateError)
...
export default CustomerInvoiceToDeleteModal
