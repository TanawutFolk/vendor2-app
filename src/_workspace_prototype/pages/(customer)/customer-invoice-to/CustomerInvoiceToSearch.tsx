...
import { PREFIX_QUERY_KEY } from '@/_workspace/react-query/hooks/useCustomerInvoiceToData'
...
function CustomerInvoiceToSearch({ setIsEnableFetching }: Props) {
  // States
    ...
    const dataItem = {
      ...
      USER_PROFILE_SETTING_PROGRAM_DATA: {
        searchFilters: {
          ...
          customerInvoiceToName: getValues('searchFilters.customerInvoiceToName'),
          customerInvoiceToAlphabet: getValues('searchFilters.customerInvoiceToAlphabet'),
            ...
            <>
              <Grid container spacing={4}>
                <Grid item xs={12} sm={4} lg={3}>
                  <Controller
                    name='searchFilters.customerInvoiceToName'
                    control={control}
                    render={({ field }) => (
                      <CustomTextField
                        {...field}
                ...
                <Grid item xs={12} sm={4} lg={3}>
                  <Controller
                    name='searchFilters.customerInvoiceToAlphabet'
                    control={control}
                    render={({ field }) => (
                      <CustomTextField
                        {...field}
...
export default CustomerInvoiceToSearch
