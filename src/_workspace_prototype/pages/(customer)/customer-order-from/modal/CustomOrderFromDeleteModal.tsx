...
import { PREFIX_QUERY_KEY, useDeleteCustomerOrderFrom } from '@/_workspace/react-query/hooks/useCustomerOrderFromData'
...
interface CustomerOrderFromDeleteModalProps {
...
// Types
const CustomOrderFromDeleteModal = ({
  openModalDelete,
  setOpenModalDelete,
  rowSelected,
  setIsEnableFetching
}: CustomerOrderFromDeleteModalProps) => {
  // useState
  ...
  const mutation = useDeleteCustomerOrderFrom(onMutateSuccess, onMutateError)
...
export default CustomOrderFromDeleteModal
