...
import { Card, CardContent, Stack, Table, TableBody, TableCell, TableRow } from '@mui/material'
    ...
    switch (mode) {
      ...
      case 'View':
        ...
        return {
          ...
          loc: rowSelected?.original?.LOC
            ? rowSelected?.original?.LOC.map((row: any, idx: number) => ({
                NO: idx + 1,
                                    ...
                                    <TableCell>
                                      ...
                                      <AsyncSelectCustom
                                        ...
                                        onChange={value => {
                                          ...
                                          if (value?.LOC_TYPE_ID == null) {
                                            ToastMessageError({
                                              title: 'LOC TYPE is NULL',
                                              message: (
                                                <>
                                                  LOC TYPE has no data.
                                                  <br />
                                                  Please add it in the LOC menu.
                                                </>
                                              )
                                            })
                                            setValue(
