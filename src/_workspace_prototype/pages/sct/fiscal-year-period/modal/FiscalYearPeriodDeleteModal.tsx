...
import { PREFIX_QUERY_KEY, useDelete } from '@/_workspace/react-query/hooks/useFiscalYearPeriodData'
...
// Types
const FiscalYearPeriodDeleteModal = ({
  openDeleteModal,
  setOpenModalDelete,
  rowSelected,
  setIsEnableFetching
}: FiscalYearPeriodModalProps) => {
  // useState
  ...
  // Functions
  const handleDeleteFiscalYearPeriod = () => {
  ...
  return (
    <>
      <ConfirmModal
        ...
        onConfirmClick={handleDeleteFiscalYearPeriod}
...
export default FiscalYearPeriodDeleteModal
