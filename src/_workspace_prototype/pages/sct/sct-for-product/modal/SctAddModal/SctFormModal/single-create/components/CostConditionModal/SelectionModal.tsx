  ...
  const onSubmit = () => {
    if (
      ...
      const message = {
        ...
        message: 'Please select all cost conditions'
      }
                  ...
                  <ButtonGroup variant='outlined' aria-label='Basic button group' color='secondary'>
                    ...
                    >
                      {watch('COST_CONDITION.INDIRECT_COST_CONDITION')
                        ...
                        : 'Select Indirect Cost Condition'}
                    </Button>
                  </ButtonGroup>
