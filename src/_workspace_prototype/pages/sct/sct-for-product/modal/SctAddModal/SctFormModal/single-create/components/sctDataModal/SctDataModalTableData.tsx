...
// Types Imports
import { FormData } from './SctDataModal'
    ...
    renderRowActions: ({ row }) => (
      <>
        <Button
          ...
          onClick={() => {
            if (getValuesMain('isMultipleCreate')) {
              setValueMain(masterDataType, {
            ...
            } else if (masterDataType === 'SCT_COMPARE_NO_1' || masterDataType === 'SCT_COMPARE_NO_2') {
              // set SCT_COMPARE
