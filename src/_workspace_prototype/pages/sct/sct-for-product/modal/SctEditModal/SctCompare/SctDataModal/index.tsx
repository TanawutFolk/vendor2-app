  ...
  const reactHookFormMethods = useForm<FormDataPage>({
    ...
    defaultValues: {
      ...
      searchResults: {
        ...
        sorting: [
          {
            id: 'FISCAL_YEAR', // accessorKey of the column
            desc: true // false = ascending, true = descending
          },
          {
            id: 'SCT_PATTERN_NAME', // accessorKey of the column
            desc: true // false = ascending, true = descending
          },
          {
            id: 'SCT_REVISION_CODE', // accessorKey of the column
            desc: true // false = ascending, true = descending
          }
        ],
        density: 'compact',
