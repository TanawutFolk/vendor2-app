  ...
  const table = useMaterialReactTable({
    ...
    renderTopToolbarCustomActions: () => (
      <div
        ...
        style={{
          gridTemplateColumns: '100px auto 100px auto'
        }}
      >
        {/* Row 1 */}
        <Typography className='font-bold'>Yield Rate &nbsp;:</Typography>
        {!yieldRateAndGoStraightRate_total?.version ? (
          <Chip label='No data found' variant='filled' color='warning' size='small' />
        ) : (
          // <Typography>
          ...
          // </Typography>
          <Chip
            label={`${yieldRateAndGoStraightRate_total?.fiscalYear} Ver. ${yieldRateAndGoStraightRate_total?.version}`}
            variant='outlined'
            color='success'
            size='small'
          />
        )}
        <Typography className='font-medium'>Flow Code :</Typography>
        {!yieldRateAndGoStraightRate_total?.flowId ? (
          <Chip label='No data found' variant='filled' color='warning' size='small' />
        ) : (
          <div className='flex items-center gap-0'>
            {yieldRateAndGoStraightRate_total?.flowId !== flowId ? (
              <Chip label='Flow code doesn’t match.' variant='filled' color='error' size='small' />
            ) : (
              // <Typography>{yieldRateAndGoStraightRate_total?.flowCode}</Typography>
              <Chip
                label={yieldRateAndGoStraightRate_total?.flowCode}
                variant='outlined'
                color='success'
                size='small'
              />
        ...
        {/* Row 2 */}
        <Typography className='font-bold'>Clear Time :</Typography>
        {!watch('directCost.flowProcess.total.main.clearTime.version') ? (
          <Chip label='No data found' variant='filled' color='warning' size='small' />
        ) : (
          <Chip
            label={`${watch('directCost.flowProcess.total.main.clearTime.fiscalYear')} Ver. ${watch('directCost.flowProcess.total.main.clearTime.version')}`}
            variant='outlined'
            color='success'
            size='small'
          />
        ...
        <Typography className='font-medium'>Flow Code :</Typography>
        {!watch('directCost.flowProcess.total.main.clearTime.flowId') ? (
          <Chip label='No data found' variant='filled' color='warning' size='small' />
        ) : watch('directCost.flowProcess.total.main.clearTime.flowId') !== watch('header.bom.FLOW_ID') ? (
          <Chip label='Flow code doesn’t match.' variant='filled' color='error' size='small' />
        ) : (
          <Chip
            label={watch('directCost.flowProcess.total.main.clearTime.flowCode')}
            variant='outlined'
            color='success'
            size='small'
          />
