...
import YieldRateGoStraightRateSearch from './YieldRateGoStraightRateSearch'
import YieldRateGoStraightRateTableData from './YieldRateGoStraightRateTableData'
...
function YieldRateGoStraightRate({
  isOpenModal,
  setIsOpenModal,
  FISCAL_YEAR,
  PRODUCT_TYPE,
      ...
      >
        <DialogTitle id='max-width-dialog-title'>
          <Typography variant='h5' component='span'>
            Select a Yield Rate & Go Straight Rate
          </Typography>
        ...
        <DialogContent>
          <FormProvider {...reactHookFormMethods}>
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <YieldRateGoStraightRateSearch setIsEnableFetching={setIsEnableFetching} />
              </Grid>
              <Grid item xs={12}>
                <YieldRateGoStraightRateTableData
...
export default YieldRateGoStraightRate
