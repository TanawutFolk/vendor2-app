...
// React Query Imports
import { PREFIX_QUERY_KEY } from '@/_workspace/react-query/hooks/useYieldRateGoStraightRateTotalForSctData'
...
const YieldRateGoStraightRateSearch = ({ setIsEnableFetching }: Props) => {
  // States
...
export default YieldRateGoStraightRateSearch
