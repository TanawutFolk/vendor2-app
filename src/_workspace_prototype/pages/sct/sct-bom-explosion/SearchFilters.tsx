    ...
    const dataItem = {
      ...
      USER_PROFILE_SETTING_PROGRAM_DATA: {
        searchFilters: {
          ...
          hasIndirectCost: getValues('searchFilters.hasIndirectCost'),
          ...
          {isLoading ? (
            ...
            <>
                  ...
                  <Controller
                    ...
                    render={({ field: { ...fieldProps } }) => (
                      <CustomTextField
                        ...
                        helperText={`Please separate multiple items with a comma (,)`}
                        placeholder='Enter ...'
              ...
              <Grid container className='mbs-0' spacing={4}>
                ...
                <Grid item xs={12} sm={2}>
                  <Controller
                    name='searchFilters.hasIndirectCost'
                    control={control}
                    render={({ field: { ...fieldProps } }) => (
                      <SelectCustom
                        {...fieldProps}
