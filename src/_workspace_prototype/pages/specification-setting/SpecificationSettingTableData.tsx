...
//   , "PRODUCT_SPECIFICATION_DOCUMENT_SETTING_VERSION_REVISION":"${PRODUCT_SPECIFICATION_DOCUMENT_SETTING_VERSION_REVISION}"
//   , "PRODUCT_PART_NUMBER":"${PRODUCT_PART_NUMBER || ''}"
...
function SpecificationSettingTableData({ isEnableFetching, setIsEnableFetching }: Props) {
  ...
  useEffect(() => {
    if (isFetching === false) {
      ...
      console.log('paramForSearchhhhhhhhhhh', paramForSearch)
    }
  }, [isFetching])
