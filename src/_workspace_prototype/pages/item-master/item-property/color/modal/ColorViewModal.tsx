...
interface ViewModalProps {
  ...
  setRowSelected: Dispatch<SetStateAction<MRT_Row<ColorI> | null>>
}

const ColorViewModal = ({ openModalView, setOpenModalView, rowSelected, setRowSelected }: ViewModalProps) => {
