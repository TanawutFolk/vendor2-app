...
import ItemCategoryAddModal from './modal/ItemCategoryAddModal'
import ItemCategoryEditModal from './modal/ItemCategoryEditModal'
import ItemCategoryDeleteModal from './modal/ItemCategoryDeleteModal'
import ItemCategoryViewModal from './modal/ItemCategoryViewModal'
...
import { useSearch } from '@/_workspace/react-query/hooks/useItemCategory'
// Types Imports
...
export interface ReturnApiSearchItemCategoryI {
  ITEM_CATEGORY_NAME: string
  ITEM_CATEGORY_ALPHABET: string
  INUSE: string | number
  Start: number
...
const ItemCategoryTableData = ({ isEnableFetching, setIsEnableFetching }: Props) => {
  const [openModalAdd, setOpenModalAdd] = useState<boolean>(false)
  const [openModalEdit, setOpenModalEdit] = useState<boolean>(false)
  const [openModalDelete, setOpenModalDelete] = useState<boolean>(false)
  const [openModalView, setOpenModalView] = useState<boolean>(false)

  const [rowSelected, setRowSelected] = useState<MRT_Row<ItemCategoryI> | null>(null)

  // Functions
  const handleClickOpen = () => setOpenModalAdd(true)
  const handleClickOpenModalView = (row: MRT_Row<ItemCategoryI>) => {
  ...
  //   ITEM_CATEGORY_NAME: getValues('searchFilters.ITEM_CATEGORY_NAME') || undefined,
  //   ITEM_CATEGORY_ALPHABET: getValues('searchFilters.ITEM_CATEGORY_ALPHABET') || undefined,
    ...
    SearchFilters: [
      {
        ...
        value: getValues('searchFilters.ITEM_CATEGORY_NAME') || ''
      },
      {
        id: 'ITEM_CATEGORY_ALPHABET',
        value: getValues('searchFilters.ITEM_CATEGORY_ALPHABET') || ''
      },
      {
        id: 'inuseForSearch',
  ...
  const columns = useMemo<MRT_ColumnDef<ItemCategoryI>[]>(
    () => [
      {
      ...
      },
      {
        ...
        header: 'ITEM_CATEGORY ID',
        enableColumnFilter: false
      },
      {
        accessorKey: 'ITEM_CATEGORY_NAME',
        header: 'ITEM_CATEGORY NAME',
        filterVariant: 'text',
      ...
      },
      {
        ...
        header: 'ITEM_CATEGORY SHORT NAME',
        filterVariant: 'text',
        columnFilterModeOptions: ['endsWith', 'startsWith', 'contains', 'equals', 'notEquals'],
        filterFn: 'contains'
      },
      {
        accessorKey: 'PURCHASE_MODULE_NAME',
        header: 'PURCHASE MODULE NAME',
        filterVariant: 'text',
        columnFilterModeOptions: ['endsWith', 'startsWith', 'contains', 'equals', 'notEquals'],
        filterFn: 'contains'
      },
...
export default ItemCategoryTableData
