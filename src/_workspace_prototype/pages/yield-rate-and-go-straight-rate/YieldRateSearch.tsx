...
const YieldRateSearch = ({ setIsEnableFetching }: Props) => {
    ...
    const dataItem = {
      ...
      USER_PROFILE_SETTING_PROGRAM_DATA: {
        searchFilters: {
          ...
          yieldRateOption: getValues('searchFilters.yieldRateOption'),
  ...
  const onResetFormSearch = () => {
    console.log(getValues('searchFilters.includingCancelled'))
    setValue('searchFilters.includingCancelled', false, { shouldDirty: true, shouldTouch: true, shouldValidate: true })
    ...
    setValue('searchFilters.yieldRateOption', {
      value: 'All',
      label: 'All',
      icon: 'tabler-checks'
    })
    setValue('searchFilters.status', null, { shouldDirty: true, shouldTouch: true, shouldValidate: true })
              ...
              <Grid container item xs={12} spacing={4}>
                    ...
                    render={({ field: { ref, onChange, ...fieldProps } }) => (
                      <>
                        <AsyncSelectCustom
                          ...
                          loadOptions={inputValue => {
                            const productCategoryId = getValues('searchFilters.PRODUCT_CATEGORY')?.PRODUCT_CATEGORY_ID
                ...
                <Grid item xs={12} sm={4}>
                  <Controller
                    ...
                    render={({ field: { ref, onChange, ...fieldProps } }) => (
                      <AsyncSelectCustom
                        key={`${watch('searchFilters.PRODUCT_CATEGORY')?.PRODUCT_CATEGORY_ID}_${watch('searchFilters.PRODUCT_MAIN')?.PRODUCT_MAIN_ID}`}
                        {...fieldProps}
                        label='Product Sub'
                        isClearable
                        cacheOptions
                        ...
                        loadOptions={inputValue => {
                          const productCategoryId = getValues('searchFilters.PRODUCT_CATEGORY')?.PRODUCT_CATEGORY_ID
                          const productMainId = getValues('searchFilters.PRODUCT_MAIN')?.PRODUCT_MAIN_ID
                ...
                <Grid item xs={12} sm={2} lg={2}>
                  <Controller
                    name='searchFilters.yieldRateOption'
                    control={control}
                    defaultValue={{
                      value: 'All',
                      label: 'All',
