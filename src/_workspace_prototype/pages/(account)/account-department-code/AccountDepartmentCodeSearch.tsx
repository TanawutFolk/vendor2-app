...
import { PREFIX_QUERY_KEY } from '@/_workspace/react-query/hooks/useAccountDepartmentCode'

interface Props {
  setIsEnableFetching: Dispatch<SetStateAction<boolean>>
}
function AccountDepartmentCodeSearch({ setIsEnableFetching }: Props) {
  // States
    ...
    const dataItem = {
      ...
      USER_PROFILE_SETTING_PROGRAM_DATA: {
        searchFilters: {
          ...
          accountDepartmentName: getValues('searchFilters.accountDepartmentName'),
          accountDepartmentCode: getValues('searchFilters.accountDepartmentCode'),
          ...
          <>
            <Grid container spacing={4}>
              <Grid item xs={12} sm={4} lg={3}>
                <Controller
                  name='searchFilters.accountDepartmentName'
                  control={control}
                  render={({ field }) => (
                    <CustomTextField
                      {...field}
              ...
              <Grid item xs={12} sm={4} lg={3}>
                <Controller
                  name='searchFilters.accountDepartmentCode'
                  control={control}
                  render={({ field }) => (
                    <CustomTextField
                      {...field}
...
export default AccountDepartmentCodeSearch
