...
const BoiUnitViewModal = ({ openModalView, setOpenModalView, rowSelected, setIsEnableFetching }: ViewModalProps) => {
  // States : Dialog
  ...
  const { control, getValues, handleSubmit } = useForm<FormData>({
    ...
    defaultValues: {
      ...
      BOI_UNIT_NAME: rowSelected?.original.BOI_UNIT_NAME,
  ...
  const handleUpdate = () => {
    ...
    const dataItem = {
      ...
      BOI_UNIT_NAME: getValues('BOI_UNIT_NAME'),
...
export default BoiUnitViewModal
