...
const createByImportFile = (dataItem: any) => {
  const data = StandardPriceServices.createByImportFile(dataItem)
  return data
}

const useCreateByImportFile = (onSuccess: any, onError: any) => {
  return useMutation({
    mutationFn: createByImportFile,
    onSuccess,
    onError
  })
}
...
export { useCreate, useCreateByImportFile, useDelete, useSearch }
