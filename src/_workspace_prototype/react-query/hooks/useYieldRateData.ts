...
const fetchExportYieldRate = (data: any) => {
  return new Promise<Blob | null>(resolve => {
    YieldRateServices.downloadFileForExportYieldRate(data)
      .then(responseJson => {
...
export {
  fetchExportYieldRate,
  useCreate,
  useCreateYieldRateExport,
  useCreateYieldRateImport,
  useDelete,
  useSearch,
  useUpdate
}
