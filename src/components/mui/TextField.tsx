...
const TextFieldStyled = styled(TextField, {
  shouldForwardProp: prop => prop !== 'disabledBg'
})<TextFieldProps & { disabledBg?: string }>(({ theme, disabledBg }) => ({
  '& .MuiInputLabel-root': {
    transform: 'none',
    width: 'fit-content',
    maxWidth: '100%',
  ...
  '& .MuiInputBase-root': {
    ...
    '&.Mui-disabled': {
      backgroundColor: disabledBg ? `${disabledBg} !important` : 'var(--mui-palette-action-hover) !important',
      border: 'none'
    }
  },
