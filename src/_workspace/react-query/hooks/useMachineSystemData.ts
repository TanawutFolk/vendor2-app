import MachineSystemRegisterServices from '@/_workspace/services/MachineSystemServices'
import { MachineSystemRegisterInterface } from '@/_workspace/types/MachineSystemTypes'
import type ResultDataResponseI from '@/libs/axios/types/ResultDataResponseI'
import { keepPreviousData, useMutation, useQuery } from '@tanstack/react-query'

export const PREFIX_QUERY_KEY = 'MACHINE_SYSTEM_REGISTER'
