...
const VendorProfileSection = ({ editingMode, originalData, fetchVendorTypes, fetchCountries }: VendorProfileSectionProps) => {
  ...
  const currentVendorTypeLabel = watchedVendorTypeName || originalData?.vendor_type_name || ''
  const currentVendorTypeId = watchedVendorTypeId ?? originalData?.vendor_type_id ?? null
