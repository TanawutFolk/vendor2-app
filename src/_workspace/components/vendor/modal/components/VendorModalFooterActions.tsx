...
import type { VendorModalFooterActionsProps } from '@/_workspace/types/vendor/VendorTypes'
...
const VendorModalFooterActions = ({
  ...
  return (
    ...
    >
      ...
      <Button onClick={onClose} disabled={saving} variant='tonal' color='secondary' sx={{ fontWeight: 700 }}>
