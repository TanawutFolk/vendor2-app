import type { StatusOption } from '@/_workspace/services/_register-request/RegisterRequestServices'
...
export const buildWorkflowStepMasterIds = (options: StatusOption[] = []): WorkflowStepMasterIds =>
...
export const buildApprovalStepStatusMasterIds = (
