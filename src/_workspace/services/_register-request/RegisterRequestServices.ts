...
export default class RegisterRequestServices {
  ...
  static getApprovalSteps(
    data: Record<string, unknown>
  ): Promise<AxiosResponse<RegisterRequestResponseI<ApprovalStep[]>>> {
  ...
  static getApprovalLogs(
    data: Record<string, unknown>
  ): Promise<AxiosResponse<RegisterRequestResponseI<ApprovalLog[]>>> {
  ...
  // Save Supplier / Outsourcing Selection Form data
  static saveSelectionForm(data: Record<string, unknown>): Promise<AxiosResponse<RegisterRequestResponseI<any>>> {
    return axiosRequest<RegisterRequestResponseI<any>>({
      url: `${RegisterRequestAPI.API_ROOT_URL}/saveSelectionForm`,
      data,
      method: 'POST'
    })
  }

  static saveAccountVendorCode(data: Record<string, unknown>): Promise<AxiosResponse<RegisterRequestResponseI<any>>> {
    return axiosRequest<RegisterRequestResponseI<any>>({
      url: `${RegisterRequestAPI.API_ROOT_URL}/saveAccountVendorCode`,
      data,
      method: 'POST'
    })
  }
  ...
  static gprCActionRequiredQueue(
    data: Record<string, unknown>
  ): Promise<AxiosResponse<RegisterRequestResponseI<Record<string, unknown>[]>>> {
    return axiosRequest<RegisterRequestResponseI<Record<string, unknown>[]>>({
  ...
  static resolveEmployeeProfile(data: Record<string, unknown>): Promise<
    AxiosResponse<
      RegisterRequestResponseI<{
        empcode: string
        name: string
  ...
  static getSelectionForm(data: Record<string, unknown>): Promise<AxiosResponse<RegisterRequestResponseI<any>>> {
    return axiosRequest<RegisterRequestResponseI<any>>({
  ...
  static addDocument(formData: FormData): Promise<
    AxiosResponse<
      RegisterRequestResponseI<{
        DOCUMENT_ID: number
...
export interface StatusOption {
  ...
  DEFAULT_APPROVAL_GROUP_ID_LOCAL?: number | null
  DEFAULT_APPROVAL_GROUP_ID_OVERSEA?: number | null
...
export type RawStatusOption = Omit<StatusOption, 'chipColor' | 'accent' | 'icon'> &
  Partial<Pick<StatusOption, 'chipColor' | 'accent' | 'icon'>>
