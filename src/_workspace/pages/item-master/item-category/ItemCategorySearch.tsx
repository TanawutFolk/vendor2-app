...
// React Query Imports
import { PREFIX_QUERY_KEY } from '@/_workspace/react-query/hooks/useItemCategory'
...
const ItemCategorySearch = ({ setIsEnableFetching }: Props) => {
  // States
            ...
            <>
              <Grid container spacing={4}>
                <Grid item xs={12} sm={4} lg={4}>
                  <Controller
                    name='searchFilters.ITEM_CATEGORY_NAME'
                    control={control}
                    render={({ field }) => (
                      <CustomTextField
                        {...field}
                ...
                <Grid item xs={12} sm={4} lg={4}>
                  <Controller
                    name='searchFilters.ITEM_CATEGORY_ALPHABET'
                    control={control}
                    render={({ field }) => (
                      <CustomTextField
                        {...field}
