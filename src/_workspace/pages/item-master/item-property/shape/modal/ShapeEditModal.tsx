...
import { PREFIX_QUERY_KEY, useUpdate } from '@/_workspace/react-query/hooks/useShapeData'
...
const ShapeEditModal = ({ openModalEdit, setOpenModalEdit, rowSelected, setIsEnableFetching }: EditModalProps) => {
  // States : Dialog
  ...
  const handleUpdate = () => {
    ...
    const dataItem = {
      ITEM_PROPERTY_SHAPE_ID: rowSelected?.original.ITEM_PROPERTY_SHAPE_ID,
