...
import ShapeWatch from './ShapeWatch'
import ShapeTableData from './ShapeTableData'
...
const schema = object({
  searchFilters: object({
    ITEM_PROPERTY_SHAPE_NAME: nullable(string()),
    INUSE: nullable(
      object({
        value: number(),
        label: string()
    ...
    <Grid container spacing={6}>
      <FormProvider {...reactHookFormMethods}>
        ...
        >
          ...
          {isLoading ? null : <ShapeWatch />}
        </Grid>
        <Grid item xs={12}>
          <ShapeSearch setIsEnableFetching={setIsEnableFetching} />
        </Grid>
        <Grid item xs={12}>
          {isLoading ? (
            'Loading'
          ) : (
            <ShapeTableData isEnableFetching={isEnableFetching} setIsEnableFetching={setIsEnableFetching} />
          )}
        </Grid>
      </FormProvider>
    </Grid>
