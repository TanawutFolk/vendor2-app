...
import { maxLength, nonEmpty, object, pipe, string, transform, type Input } from 'valibot'
...
import { PREFIX_QUERY_KEY, useUpdate } from '@/_workspace/react-query/hooks/useMakerData'
...
const MakerEditModal = ({ openModalEdit, setOpenModalEdit, rowSelected, setIsEnableFetching }: EditModalProps) => {
  // States : Dialog
  ...
  const handleUpdate = () => {
    ...
    const dataItem = {
      MAKER_ID: rowSelected?.original.MAKER_ID,
