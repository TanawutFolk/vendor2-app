...
import { useSaveAssignee } from '@/_workspace/react-query/hooks/useAssignees'
...
const defaultAssigneeFormValues: FormData = {
...
const mapGroupOption = (item: GroupOptionSource): GroupOption => ({
  ...
  value: String(item.value || item.GROUP_CODE || '')
    .trim()
    .toUpperCase()
})
    ...
    >
      <DialogTitle>
        <Typography variant='h5' component='span'>
          {initialData ? 'Edit Assignee' : 'Add New Assignee'}
        </Typography>
