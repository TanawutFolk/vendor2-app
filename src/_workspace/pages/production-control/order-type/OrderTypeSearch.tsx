...
const OrderTypeSearch = ({ setIsEnableFetching }: Props) => {
  ...
  const onResetFormSearch = () => {
    setValue('searchFilters.ORDER_TYPE_NAME', '')
    setValue('searchFilters.ORDER_TYPE_ALPHABET', '')
  ...
  const handleAdd = () => {
    const dataItem = {
      ...
      USER_PROFILE_SETTING_PROGRAM_DATA: {
        searchFilters: {
          ORDER_TYPE_NAME: getValues('searchFilters.ORDER_TYPE_NAME'),
          ORDER_TYPE_ALPHABET: getValues('searchFilters.ORDER_TYPE_ALPHABET'),
        ...
        <CardContent>
          <Grid container spacing={4}>
            <Grid item xs={12} sm={4} lg={3}>
              <Controller
                control={control}
                name='searchFilters.ORDER_TYPE_NAME'
            ...
            <Grid item xs={12} sm={4} lg={3}>
              <Controller
                control={control}
                name='searchFilters.ORDER_TYPE_ALPHABET'
                render={({ field: { ref, ...fieldProps } }) => (
                  <CustomTextField
