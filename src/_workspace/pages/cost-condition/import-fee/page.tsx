...
// Components Imports
import ImportFeeWatch from './ImportFeeWatch'
import ImportFeeSearch from './ImportFeeSearch'
import ImportFeeTableData from './ImportFeeTableData'
...
const columns = ['ITEM_IMPORT_TYPE_NAME', 'IMPORT_FEE_RATE', 'FISCAL_YEAR', 'VERSION', 'UPDATE_DATE', 'UPDATE_BY']
    ...
    <Grid container spacing={6}>
      <FormProvider {...reactHookFormMethods}>
        ...
        >
          ...
          {isLoading ? null : <ImportFeeWatch />}
        </Grid>
        <Grid item xs={12}>
          <ImportFeeSearch setIsEnableFetching={setIsEnableFetching} />
        </Grid>
        <Grid item xs={12}>
          {isLoading ? (
            'Loading'
          ) : (
            <ImportFeeTableData isEnableFetching={isEnableFetching} setIsEnableFetching={setIsEnableFetching} />
          )}
        </Grid>
      </FormProvider>
    </Grid>
