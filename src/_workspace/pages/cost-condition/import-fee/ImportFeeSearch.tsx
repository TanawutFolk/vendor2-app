...
// React Query Imports
import { PREFIX_QUERY_KEY } from '@/_workspace/react-query/hooks/useImportFee'
...
const ImportFeeSearch = ({ setIsEnableFetching }: Props) => {
  // States
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, ...fieldProps } }) => (
                      <AsyncSelectCustom<ItemImportTypeOption>
                        ...
                        cacheOptions
                        defaultOptions
                        value={watch('searchFilters.ITEM_IMPORT_TYPE')}
                        onChange={value => {
                          onChange(value)
                        }}
...
export default ImportFeeSearch
