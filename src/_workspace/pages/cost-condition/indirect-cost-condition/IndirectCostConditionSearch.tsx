...
// React Query Imports
import { PREFIX_QUERY_KEY } from '@/_workspace/react-query/hooks/useIndirectCostCondition'
...
const IndirectCostConditionSearch = ({ setIsEnableFetching }: Props) => {
  // States
...
export default IndirectCostConditionSearch
