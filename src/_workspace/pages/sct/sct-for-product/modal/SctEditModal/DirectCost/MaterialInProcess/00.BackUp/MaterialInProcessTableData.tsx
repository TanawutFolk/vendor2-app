...
import YieldAccumulation from './Columns/YieldAccumulation'
import PurchasePrice from './Columns/PurchasePrice'
import Amount from './Columns/Amount'
import UsagePrice from './Columns/UsagePrice'
...
const MaterialInProcessTableData = () => {
  ...
  const materialInProcess = useWatch({
    control,
