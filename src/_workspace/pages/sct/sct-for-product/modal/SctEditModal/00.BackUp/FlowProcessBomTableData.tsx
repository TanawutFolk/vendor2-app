...
const FlowProcessBomTableData = () => {
  const { getValues, watch, setValue, control } = useFormContext<FormDataPage>()
  ...
  const SCT_RESOURCE_OPTION_ID_yieldRateAndGoStraightRate = useWatch({
    control,
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (getValues('isCalculationAlready')) {
        await YieldRateGoStraightRateProcessForSctServices.getByProductTypeIdAndFiscalYearAndRevisionNo({
          FISCAL_YEAR: getValues('directCost.flowProcess.total.main.yieldRateAndGoStraightRate.fiscalYear'),
          REVISION_NO: getValues('directCost.flowProcess.total.main.yieldRateAndGoStraightRate.revisionNo'),
          PRODUCT_TYPE_ID: getValues('product.productType.PRODUCT_TYPE_ID')
        })
          .then(res => {
            setValue('directCost.flowProcess.body.yieldRateGoStraightRateProcessForSct.main', res.data.ResultOnDb, {
              shouldValidate: true,
              shouldDirty: true,
              shouldTouch: true
            })
          ...
          .catch(() => {
            toast.error(`Failed to fetch Yield Rate and Go Straight Rate Process for SCT. Please check your data.`, {
              autoClose: 10000
            })
          })
      } else {
        if (getValues('masterDataSelection.yieldRateAndGoStraightRate.SCT_RESOURCE_OPTION_ID') == 1) {
          await YieldRateGoStraightRateProcessForSctServices.getByProductTypeIdAndFiscalYear_MasterDataLatest({
          ...
          [2, 4].includes(getValues('masterDataSelection.yieldRateAndGoStraightRate.SCT_RESOURCE_OPTION_ID'))
        ) {
          await YieldRateGoStraightRateProcessForSctServices.getByProductTypeIdAndFiscalYearAndRevisionNo({
            FISCAL_YEAR: getValues('directCost.flowProcess.total.main.yieldRateAndGoStraightRate.fiscalYear'),
            REVISION_NO: getValues('directCost.flowProcess.total.main.yieldRateAndGoStraightRate.revisionNo'),
    ...
    if (SCT_RESOURCE_OPTION_ID_yieldRateAndGoStraightRate) fetchData()
  }, [
    SCT_RESOURCE_OPTION_ID_yieldRateAndGoStraightRate,
    yieldRateAndGoStraightRate?.fiscalYear,
    yieldRateAndGoStraightRate?.revisionNo
  ])
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (getValues('isCalculationAlready')) {
        await ClearTimeProcessForSctServices.getByProductTypeIdAndFiscalYearAndRevisionNo({
          FISCAL_YEAR: getValues('directCost.flowProcess.total.main.clearTime.fiscalYear'),
          REVISION_NO: getValues('directCost.flowProcess.total.main.clearTime.revisionNo'),
          PRODUCT_TYPE_ID: getValues('product.productType.PRODUCT_TYPE_ID')
        })
          .then(res => {
            setValue('directCost.flowProcess.body.clearTimeForSctProcess.main', res.data.ResultOnDb, {
              shouldValidate: true,
              shouldDirty: true,
              shouldTouch: true
            })
        ...
        if (getValues('masterDataSelection.clearTime.SCT_RESOURCE_OPTION_ID') == 1) {
          await ClearTimeProcessForSctServices.getByProductTypeIdAndFiscalYear_MasterDataLatest({
            FISCAL_YEAR: getValues('header.fiscalYear.value'),
            PRODUCT_TYPE_ID: getValues('product.productType.PRODUCT_TYPE_ID')
          })
            .then(res => {
        ...
        } else if ([2, 4].includes(getValues('masterDataSelection.clearTime.SCT_RESOURCE_OPTION_ID'))) {
          await ClearTimeProcessForSctServices.getByProductTypeIdAndFiscalYearAndRevisionNo({
            FISCAL_YEAR: getValues('directCost.flowProcess.total.main.clearTime.fiscalYear'),
            REVISION_NO: getValues('directCost.flowProcess.total.main.clearTime.revisionNo'),
            PRODUCT_TYPE_ID: getValues('product.productType.PRODUCT_TYPE_ID')
    ...
    if (clearTime?.fiscalYear && clearTime?.revisionNo) fetchData()
  }, [clearTime?.fiscalYear, clearTime?.revisionNo])
          ...
          },
          {
            ...
            Cell: ({ row }) => {
              const main = () => {
                ...
                const clearTimeValue = listClearTimeProcessForSct.find(
                  v =>
                    v.FLOW_ID === row.original.FLOW_ID &&
                    v.FLOW_ID === row.original.FLOW_ID &&
                    v.PROCESS_ID === row.original.PROCESS_ID
                )
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            <div className='flex items-center gap-1'>
              ...
              <Typography>{watch('directCost.flowProcess.total.main.yieldRateAndGoStraightRate.flowCode')}</Typography>

              {watch('directCost.flowProcess.total.main.yieldRateAndGoStraightRate.flowId') !=
              watch('header.bom.FLOW_ID') ? (
            ...
            <div className='flex items-center gap-1'>
              ...
              <Typography>
                {watch('directCost.flowProcess.total.main.clearTime.fiscalYear') ?? ''} Rev.
      ...
      <div className='flex items-center justify-end gap-2 p-3'>
        <div className='flex items-center gap-2'>
          <Typography variant='body1'>
            ...
            Showing {getValues('directCost.flowProcess.total.main.totalCountProcess')} entries
          </Typography>
