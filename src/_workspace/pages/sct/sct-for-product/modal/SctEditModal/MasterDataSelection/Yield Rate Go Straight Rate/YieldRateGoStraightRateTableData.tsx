...
import { useSearch } from '@/_workspace/react-query/hooks/useYieldRateGoStraightRateTotalForSctData'
...
export interface ReturnApiSearchYieldRateGoStraightRateTotalForSctI {
...
const getUrlParamSearch = ({
  ...
  FISCAL_YEAR,
  PRODUCT_TYPE
}: ParamApiSearchI): ReturnApiSearchYieldRateGoStraightRateTotalForSctI => {
...
const YieldRateGoStraightRateTableData = ({
  isEnableFetching,
  setIsEnableFetching,
  setIsOpenModal,
  RHF_parent,
  ...
  const columns = useMemo<MRT_ColumnDef<YieldRateGoStraightRateTotalForSctI>[]>(
    () => [
      {
      ...
      },
      {
        ...
        header: 'TOTAL YIELD RATE FOR SCT (%)',
        filterVariant: 'text',
        columnFilterModeOptions: ['endsWith', 'startsWith', 'contains', 'equals', 'notEquals'],
        filterFn: 'contains',
        size: 300
      },
      {
        ...
        header: 'TOTAL GO STRAIGHT RATE FOR SCT (%)',
        filterVariant: 'text',
        columnFilterModeOptions: ['endsWith', 'startsWith', 'contains', 'equals', 'notEquals'],
        filterFn: 'contains',
        size: 350
            ...
            onClick={() => {
              setValueParent(
                'directCost.flowProcess.total.main.yieldRateAndGoStraightRate',
                {
                  ...
                  // totalYieldRate: row.original.TOTAL_YIELD_RATE_FOR_SCT,
                  // totalGoStraightRate: row.original.TOTAL_GO_STRAIGHT_RATE_FOR_SCT,
...
export default YieldRateGoStraightRateTableData
