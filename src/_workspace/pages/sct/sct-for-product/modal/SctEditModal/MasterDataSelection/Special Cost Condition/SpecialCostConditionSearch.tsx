...
// React Query Imports
import { PREFIX_QUERY_KEY } from '@/_workspace/react-query/hooks/useSpecialCostCondition'
...
const SpecialCostConditionSearch = ({ setIsEnableFetching }: Props) => {
  // States
...
export default SpecialCostConditionSearch
