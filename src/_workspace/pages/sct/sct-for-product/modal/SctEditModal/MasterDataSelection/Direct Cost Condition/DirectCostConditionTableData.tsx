...
const DirectCostConditionTableData = ({
  isEnableFetching,
  setIsEnableFetching,
  setIsOpenModal,
  RHF_parent,
      ...
      <Button
        ...
        onClick={() => {
          setValueParent(
            ...
            {
              // directUnitProcessCost: row.original.DIRECT_UNIT_PROCESS_COST,
              // indirectRateOfDirectProcessCost: row.original.INDIRECT_RATE_OF_DIRECT_PROCESS_COST,
