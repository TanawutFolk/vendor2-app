...
import SpecialCostConditionSearch from './SpecialCostConditionSearch'
import SpecialCostConditionTableData from './SpecialCostConditionTableData'
...
function SpecialCostCondition({ isOpenModal, setIsOpenModal, FISCAL_YEAR, PRODUCT_MAIN, RHF_parent, onChange }: Props) {
      ...
      >
        <DialogTitle id='max-width-dialog-title'>
          <Typography variant='h5' component='span'>
            Select a Special Cost Condition
          </Typography>
        ...
        <DialogContent>
          <FormProvider {...reactHookFormMethods}>
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <SpecialCostConditionSearch setIsEnableFetching={setIsEnableFetching} />
              </Grid>
              <Grid item xs={12}>
                <SpecialCostConditionTableData
