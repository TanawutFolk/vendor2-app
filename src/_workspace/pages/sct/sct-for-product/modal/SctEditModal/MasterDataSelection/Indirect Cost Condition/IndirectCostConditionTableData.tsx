...
const IndirectCostConditionTableData = ({
  isEnableFetching,
  setIsEnableFetching,
  setIsOpenModal,
  RHF_parent,
      ...
      <Button
        ...
        onClick={() => {
          setValueParent(
            ...
            {
              // depreciation: row.original.DEPRECIATION,
              // labor: row.original.LABOR,
              // otherExpense: row.original.OTHER_EXPENSE,
              //totalIndirectCost: row.original.TOTAL_INDIRECT_COST,
