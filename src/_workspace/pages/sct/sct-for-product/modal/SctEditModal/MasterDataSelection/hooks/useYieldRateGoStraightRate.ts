...
const SCT_MASTER_DATA_SETTING_ID = 5 // yield rate
const SERVICE_TOTAL = YieldRateGoStraightRateTotalForSctServices
const SERVICE_PROCESS = YieldRateGoStraightRateProcessForSctServices
const TARGET_NAME_TOTAL = 'directCost.flowProcess.total.main.yieldRateAndGoStraightRate'
const TARGET_NAME_PROCESS = 'directCost.flowProcess.body.yieldRateGoStraightRateProcessForSct.main'
const MENU_NAME = 'Yield Rate & Go Straight Rate'
...
interface DataReturn {
  total: {
    ...
    totalYieldRate: number | undefined | null
    totalGoStraightRate: number | undefined | null
  }
  process: {
    yieldRateGoStraightRateProcessForSctId: string | undefined | null
    fiscalYear: number | undefined | null
    version: number | undefined | null
    ...
    yieldRateForSct: number | undefined | null
    yieldAccumulationForSct: number | undefined | null
    goStraightRateForSct: number | undefined | null
    collectionPointForSct: number | undefined | null
  }[]
  fiscalYear: number | undefined | null
  version: number | undefined | null
}
...
export function useYieldRateGoStraightRate(isLoading: boolean) {
  ...
  const [
    ...
    name: [
      ...
      'directCost.flowProcess.total.main.yieldRateAndGoStraightRate.version',
      ...
      try {
        ...
        return {
          total: {
            ...
            totalYieldRate: total.TOTAL_YIELD_RATE_FOR_SCT as number | undefined | null,
            totalGoStraightRate: total.TOTAL_GO_STRAIGHT_RATE_FOR_SCT as number | undefined | null
          },
          process: process.map(item => ({
            yieldRateGoStraightRateProcessForSctId: item.YIELD_RATE_GO_STRAIGHT_RATE_PROCESS_FOR_SCT_ID,
            fiscalYear: item.FISCAL_YEAR as number | undefined | null,
            version: item.REVISION_NO as number | undefined | null,
            ...
            yieldRateForSct: item.YIELD_RATE_FOR_SCT as number | undefined | null,
            goStraightRateForSct: item.GO_STRAIGHT_RATE_FOR_SCT as number | undefined | null,
            collectionPointForSct: item.COLLECTION_POINT_FOR_SCT as number | undefined | null,
            yieldAccumulationForSct: item.YIELD_ACCUMULATION_FOR_SCT as number | undefined | null
          })),
          fiscalYear: fiscalYear as number | undefined | null,
          version: total.REVISION_NO as number | undefined | null
        }
    ...
    try {
      ...
      if (result && !signal.aborted) {
        setValue(TARGET_NAME_TOTAL, {
          totalYieldRate: result.total.totalYieldRate,
          totalGoStraightRate: result.total.totalGoStraightRate,
