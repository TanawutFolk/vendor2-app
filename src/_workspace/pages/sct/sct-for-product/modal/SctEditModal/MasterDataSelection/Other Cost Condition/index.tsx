...
import OtherCostConditionSearch from './OtherCostConditionSearch'
import OtherCostConditionTableData from './OtherCostConditionTableData'
...
function OtherCostCondition({ isOpenModal, setIsOpenModal, FISCAL_YEAR, PRODUCT_MAIN, RHF_parent, onChange }: Props) {
        ...
        <DialogContent>
          <FormProvider {...reactHookFormMethods}>
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <OtherCostConditionSearch setIsEnableFetching={setIsEnableFetching} />
              </Grid>
              <Grid item xs={12}>
                <OtherCostConditionTableData
