...
const BoiNameForMaterialConsumableViewModal = ({
  openModalView,
  setOpenModalView,
  rowSelected,
  setIsEnableFetching
  ...
  const { control, getValues, handleSubmit } = useForm<FormData>({
    ...
    defaultValues: {
      ...
      BOI_GROUP_NO: rowSelected?.original?.BOI_GROUP_NO,
      BOI_DESCRIPTION_MAIN_NAME: rowSelected?.original?.BOI_DESCRIPTION_MAIN_NAME,
      BOI_DESCRIPTION_SUB_NAME: rowSelected?.original?.BOI_DESCRIPTION_SUB_NAME,
  ...
  const handleUpdate = () => {
    ...
    const dataItem = {
      ...
      BOI_GROUP_NO: getValues('BOI_GROUP_NO'),
      BOI_DESCRIPTION_MAIN_NAME: getValues('BOI_DESCRIPTION_MAIN_NAME'),
      BOI_DESCRIPTION_SUB_NAME: getValues('BOI_DESCRIPTION_SUB_NAME'),
      BOI_UNIT_SYMBOL: getValues('BOI_UNIT_SYMBOL'),
      ...
      >
        <DialogTitle id='max-width-dialog-title'>
          <Typography variant='h5' component='span'>
            View BOI Name For Material/Consumable
          </Typography>
        ...
        <DialogContent>
            ...
            <Controller
              ...
              render={({ field }) => (
                <CustomTextField
                  ...
                  placeholder='Enter BOI Project Code'
                  autoComplete='off'
                  disabled={true}
                />
              )}
          ...
          <Grid className='mb-3'>
            <Controller
              name='BOI_DESCRIPTION_MAIN_NAME'
              control={control}
              render={({ field }) => (
                <CustomTextField
                  {...field}
            ...
            <Controller
              ...
              render={({ field }) => (
                <CustomTextField
                  ...
                  placeholder={rowSelected?.original.BOI_DESCRIPTION_SUB_NAME === '' ? null : 'Enter...'}
                  autoComplete='off'
                  disabled={true}
                />
              )}
            ...
            <Controller
              ...
              render={({ field }) => (
                <CustomTextField
                  ...
                  placeholder='Enter BOI Product Group Name'
                  autoComplete='off'
                  disabled={true}
                />
              )}
...
export default BoiNameForMaterialConsumableViewModal
