...
import { useDeleteBoiProject, PREFIX_QUERY_KEY } from '@/_workspace/react-query/hooks/useBoiProjectData'
...
const schema = object({
  ...
  boiProductGroupName: string([])
})

interface BoiProjectDeleteModalProps {
...
// Types
const BoiProjectDeleteModal = ({
  openModalDelete,
  setOpenModalDelete,
  rowSelected,
  setIsEnableFetching
}: BoiProjectDeleteModalProps) => {
  // useState
  ...
  const mutation = useDeleteBoiProject(onMutateSuccess, onMutateError)
...
export default BoiProjectDeleteModal
