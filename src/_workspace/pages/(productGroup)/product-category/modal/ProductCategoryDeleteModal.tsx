...
import { PREFIX_QUERY_KEY, useDeleteProductCategory } from '@/_workspace/react-query/hooks/useProductCategoryData'
...
interface ProductCategoryDeleteModalProps {
...
// Types
const ProductCategoryDeleteModal = ({
  openModalDelete,
  setOpenModalDelete,
  rowSelected,
  setIsEnableFetching
}: ProductCategoryDeleteModalProps) => {
  // useState
  ...
  const mutation = useDeleteProductCategory(onMutateSuccess, onMutateError)
