    ...
    const dataItem = {
      ...
      USER_PROFILE_SETTING_PROGRAM_DATA: {
        searchFilters: {
          ...
          productSubCode: getValues('searchFilters.productSubCode'),
          productSubAlphabet: getValues('searchFilters.productSubAlphabet'),
...
export default ProductSubWatch
