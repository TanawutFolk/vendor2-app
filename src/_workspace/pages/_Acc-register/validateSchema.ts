...
export const AccRegisterSchema = z.object({
...
export type AccRegisterFormData = z.infer<typeof AccRegisterSchema>
...
export const defaultFormValues: AccRegisterFormData = {
...
export const fetchDefaultValues = async (): Promise<AccRegisterFormData> => {
    try {
        const result = await UserProfileSettingProgramServices.getByUserIdAndApplicationIdAndMenuId<
            AxiosResponseI<UserProfileSettingProgramI<AccRegisterFormData>>
