...
export const PREFIX_QUERY_KEY = 'RE_REGISTER'
            ...
            <Grid container spacing={4}>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                            <CustomTextField {...field} fullWidth label='Company Name' placeholder='Enter ...' autoComplete='off' />
                        )}
                    />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                            <CustomTextField {...field} fullWidth label='Product Name' placeholder='Enter ...' autoComplete='off' />
                        )}
                    />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                            <CustomTextField {...field} fullWidth label='Maker Name' placeholder='Enter ...' autoComplete='off' />
                        )}
                    />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                            <CustomTextField {...field} fullWidth label='Model Name' placeholder='Enter ...' autoComplete='off' />
                        )}
                    />
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                            <CustomTextField {...field} fullWidth label='Prones Code' placeholder='Enter ...' autoComplete='off' />
                        )}
                    />
                </Grid>
